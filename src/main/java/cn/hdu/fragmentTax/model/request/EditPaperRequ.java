...
public class EditPaperRequ {
    ...
    public EditPaperRequ(Integer id, String stuId, String name, String paperTitle, String journalTitle, Integer paperGrade, Integer paperState, Integer ranking, Integer totalNumber) {
        this.id = id;
        this.stuId = stuId;
        this.name = name;
