...
public class GetPaperResp {
    ...
    public GetPaperResp(Integer id, String stuId, String name, String paperTitle, String journalTitle, String paperGrade, String paperState, Integer ranking, Integer totalNumber, String status) {
        this.id = id;
        this.stuId = stuId;
        this.name = name;
