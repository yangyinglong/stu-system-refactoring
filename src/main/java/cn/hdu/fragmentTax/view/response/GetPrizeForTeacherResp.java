...
public class GetPrizeForTeacherResp {
    private String id;
    ...
    public String getInnoNum() {
        return innoNum;
    }

    public void setInnoNum(String innoNum) {
    ...
    public void setExchNum(String exchNum) {
